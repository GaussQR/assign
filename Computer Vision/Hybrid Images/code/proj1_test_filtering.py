...
mpimg.imsave('Results/sobel_image.jpg',sobel_image + 0.5)
#
#
...
mpimg.imsave('Results/laplacian_image.jpg', laplacian_image + 0.5)
#
...
mpimg.imsave('Results/high_pass_image.jpg',high_pass_image + 0.5)
